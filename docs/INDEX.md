...
- [`docs/liveness.md`](liveness.md) — silent face-anti-spoofing (MiniFASNet): crop/preprocess, the 2.7×/4.0× two-model ensemble, a focus/size/exposure quality gate, fail-closed-on-error enforcement, multi-frame temporal voting, platform coverage of identify/verify/video, and FAR/FRR tuning.
